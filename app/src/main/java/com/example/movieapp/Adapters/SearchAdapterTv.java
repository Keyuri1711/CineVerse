...
public class SearchAdapterTv extends RecyclerView.Adapter<SearchAdapterTv.GithubViewHolder> {

    private final Context context;
    private final ArrayList<Searchdetails> arrayList;

    public SearchAdapterTv(Context context, ArrayList<Searchdetails> arrayList) {
    ...
    public class GithubViewHolder extends RecyclerView.ViewHolder {
        ...
        public GithubViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent l = new Intent(context, DetailsTv.class);
        ...
        public void bind(Searchdetails user, int position) {
            ...
            releasetv.setText("First Air Date: " + user.getFirst_air_date());
            overviewtv.setText("\n" + user.getOverview());
